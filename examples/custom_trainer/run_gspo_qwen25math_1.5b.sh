...
# Experiment naming
experiment_name=gspo_qwen25math_1.5b_${dataset}_epochs${epochs}_rollouts${rollouts}_bsz${batch_size}_resp_len${response_length}_test
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=[/fast/pmayilvahanan/datasets/aime_2024/test.parquet,/fast/pmayilvahanan/datasets/aime_2025/test.parquet] \
