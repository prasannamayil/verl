...
path_to_sft_checkpoint=/fast/pmayilvahanan/post_training/verl_checkpoints/qwen2.5-7b_sft_gsm8k_epochs_2/global_step_18
experiment_name=qwen2.5-7b_function_rm_sft_init_gsm8k_steps_18
